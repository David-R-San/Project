...
parser = argparse.ArgumentParser(description="hyper-parameter for R2GenBioGPT")
...
parser.add_argument('--biogpt_model', default='microsoft/biogpt', type=str, help="language model to use")
...
parser.add_argument('--vis_use_lora', default=True, type=lambda x: (str(x).lower() == 'true'), help="whether use lora for vision model")
...
# ======================== SavedModel Configs ===========================
parser.add_argument('--savedmodel_path', type=str, default='savefulllora/biogpt_v1')
...
parser.add_argument('--reports_csv', type=str, default='C:/Users/David/Downloads/chex_clinical_project/data/normalized_reports.csv')

parser.add_argument('--projections_csv', type=str, default="C:/Users/David/Downloads/archive (1)/indiana_projections.csv", help="Path to projections CSV")
parser.add_argument('--image_dir', type=str, default="C:/Users/David/Downloads/archive (1)/images/images_normalized", help="Directory with normalized images")

parser.add_argument("--resume_training", action="store_true", help="Resume training from last checkpoint if available")
